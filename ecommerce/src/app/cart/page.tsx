                ...
                <tr key={i} className="hover:bg-gray-900 transition-colors">
                  ...
                  <td className="px-4 py-3 border-b border-gray-700 ">
                    ...
                    <div className="flex gap-3 ">
                      ...
                      <span className="text-center border-2 p-1 w-10"> {item.quantity} </span>{" "}
                  ...
                  <td className="px-4 py-3 border-b border-gray-700 ">
                    {" "}
                    <FontAwesomeIcon onClick={()=> removeItem(item)} icon={faTrash} className="cursor-pointer size-5" />{" "}
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className="col-span-1 max-md:col-span-1 w-full bg-gray-100 p-6 rounded-lg shadow-lg">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center border-t pt-4">
              ...
              <h3 className="text-gray-800 font-bold">{cartNetTotal.toFixed(2)}</h3>
            </div>
