...
const BannerEditForm = ({bannerData}: Props) => {
  ...
  const {
    ...
    defaultValues: {
        ...
        attachedFile: process.env.NEXT_PUBLIC_STORAGE_URL + bannerData.image
    }
   });
          ...
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            ...
            >
              <div>
                ...
                <p className="mt-2 text-red">{errors.subtitle?.message}</p>
              </div>
              <div>
                <label className="mb-3 block text-body-sm font-medium text-dark dark:text-white">
                  Title
                ...
                <p className="mt-2 text-red">{errors.title?.message}</p>
              </div>
